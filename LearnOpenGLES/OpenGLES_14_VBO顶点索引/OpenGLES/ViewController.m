...
@property (nonatomic, strong)CubeIndex      *cubeShape;
...
- (void)setupContext {
    ...
    self.cubeShape = [[CubeIndex alloc]initWithGLContext:self.glContext diffuseMap:self.difuseMap normalMap:self.normalMap];
}
