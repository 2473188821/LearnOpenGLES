...
@property (nonatomic, strong)Cylinder      *lind;
...
- (void)setupContext {
    ...
    self.lind = [[Cylinder alloc]initWithGLContext:self.glContext sides:5 radius:0.9 height:1.2 texture:self.difuseMap];
}
...
- (void)update {
    ...
    [self.lind update:self.elapsedTime];
}
