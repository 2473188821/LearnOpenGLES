...
@property (nonatomic, strong)WavefrontOBJ *waveOBJ;
...
//    objFilePath = [[NSBundle mainBundle] pathForResource:@"smoothMonkey" ofType:@"obj"];
...
- (void)update {
    ...
    [self.waveOBJ update:self.elapsedTime];
...
- (void)glkView:(GLKView *)view drawInRect:(CGRect)rect {
    ...
    [self.waveOBJ draw:self.glContext];
}
